<?php /* Smarty version 2.6.25, created on 2012-05-28 13:20:20
         compiled from H5C3/showmyproject.html */ ?>
...
$(document).ready(function() {
	...
	$("#account").hover(function(e) {
     ...
     <?php if ($this->_tpl_vars['project']['view_right'] == '0'): ?>
     <?php echo '*/
	 check_box("这个项目好像你没权限看到吧？","index.php");
     /*'; ?>

     <?php elseif ($this->_tpl_vars['project']['p_state'] == "-1"): ?>
     <?php echo '*/
...
<?php echo '");
     ...
     <?php elseif ($this->_tpl_vars['project']['p_state'] == '0'): ?>
     <?php echo '*/
...
<div id="left" style="overflow:auto;">
 ...
 <span style="color:#CCC;">--<?php echo $this->_tpl_vars['project']['user_name']; ?>
        ...
        <div class="c"></div>
        <?php if ($this->_tpl_vars['project_property']['p_read_right'] != 1): ?>
        	此项目详细内容不对外开放
        <?php elseif (! $this->_tpl_vars['project_detail']['0']['pd_content']): ?>
        	此项目还未填写详细内容
        <?php endif; ?>
...
<div id="right">
    ...
    <div class="c" style="padding:10px;"></div>
            <div class="menu" style="padding-left:10px;" onclick="show_or_hide('add_project_detail')">添加新内容</div>
        <form id="add_project_detail" method="post" action="index.php?act=addprojectdetail&id=<?php echo $this->_tpl_vars['pid']; ?>
">
            <textarea name="content" style="height:400px; display:block;"></textarea>
            <br />
            <input type="submit" name="button" value="提交内容" />
        </form>
            <div class="menu" style="padding-left:10px;" onclick="show_or_hide('add_project_detail')">查看日程</div>
            <div class="menu" style="padding-left:10px;" onclick="show_or_hide('add_project_detail')">查看成员</div>
</div>
</body>
</html>